...
if ( isset( $_REQUEST['event_id'] ) ) {
    $edit     = 0;
    $event_id = intval(mjschool_decrypt_id(wp_unslash($_REQUEST['event_id'] )) );
} else {
    $edit = 0;
}
...
<div class="mjschool-panel-body mjschool-custom-padding-0"><!--PANEL BODY.-->
    <form name="event_form" action="" method="post" class="mjschool-form-horizontal" enctype="multipart/form-data" id="event_form"><!--ADD EVENT FORM-->
        <?php $mjschool_action = sanitize_text_field(isset($_REQUEST['action']) ? $_REQUEST['action'] : 'insert' ); ?>
        ...
        <div class="form-body mjschool-user-form"> <!-- mjschool-user-form start.-->
            <div class="row"><!--Row Div start.-->
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                    <div class="form-group input">
                        <div class="col-md-12 form-control">
                            <input placeholder="<?php esc_html_e( 'Start Time', 'mjschool' ); ?>" type="text" value="<?php if ($edit) { echo esc_attr($result->start_time); } elseif ( isset( $_POST['start_time'] ) ) { echo esc_attr(sanitize_text_field( wp_unslash($_POST['start_time']))); } ?>" class="form-control timepicker event_start_time validate[required]" name="start_time" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                    <div class="form-group input">
                        <div class="col-md-12 form-control">
                            <input placeholder="<?php esc_html_e( 'End Time', 'mjschool' ); ?>" type="text" value="<?php if ($edit) { echo esc_attr($result->end_time); } elseif ( isset( $_POST['end_time'] ) ) { echo esc_attr(sanitize_text_field( wp_unslash($_POST['end_time']))); } ?>" class="form-control timepicker event_end_time validate[required]" name="end_time" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
