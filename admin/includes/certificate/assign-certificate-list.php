												...
												<li >
													...
													<ul class="dropdown-menu mjschool-header-dropdown-menu mjschool-action-dropdawn" aria-labelledby="dropdownMenuLink">
														<li class="mjschool-float-left-width-100px">
															<a href="<?php echo esc_url( 'admin.php?page=mjschool_certificate&tab=view_assign_certificate&action=view&certificate_type=' . $retrieved_data->certificate_type . '&action1=view&acc=' . mjschool_encrypt_id($retrieved_data->id ) . '&student_id=' . mjschool_encrypt_id($retrieved_data->student_id ) ); ?>" class="mjschool-float-left-width-100px" id="<?php echo esc_attr($retrieved_data->id); ?>">
        ...
        if ( $user_access_add === '1' ) {
            ...
            <div class="mjschool-no-data-list-div mjschool_margin_top_40px">
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=mjschool_certificate&tab=assign_certificate&action=new' ) ); ?>">
                    <img class="col-md-12 mjschool-no-img-width-100px" src="<?php echo esc_url( get_option( 'mjschool_mjschool-no-data-img' ) ); ?>" alt="<?php echo esc_attr__( 'Add Record', 'mjschool' ); ?>">
                </a>
            ...
            <div class="mjschool-calendar-event-new">
                <img class="mjschool-no-data-img" src="<?php echo esc_url( MJSCHOOL_NODATA_IMG ); ?>" alt="<?php echo esc_attr__( 'No data', 'mjschool' ); ?>">
            </div>
            <?php
        }
    }
