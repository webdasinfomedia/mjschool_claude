...
if ( get_option( 'mjschool_enable_video_popup_show' ) === 'yes' ) {
	?>
		<a href="#" class="mjschool-view-video-popup youtube-icon" link="<?php echo esc_url( 'https://www.youtube.com/embed/Nk-iedcC4Y0?si=OshxLuh2R77dCUWT' ); ?>" title="<?php esc_attr_e( 'Student ID Card', 'mjschool' ); ?>">
