...
if ( $active_tab === 'exam_time_table' ) {
    ...
    <div class="mjschool-panel-body mjschool-margin-top-20px mjschool-padding-top-25px-res">
            ...
            <div class="form-body mjschool-user-form mjschool-padding-top-25px-res">
                <div class="row">
                    <div class="col-md-8 input mjschool-exam-time-table-error-msg">
                        ...
                        $exam_id             = '';
                        // Use $_GET specifically instead of $_REQUEST for better security practice.
                        if ( isset( $_GET['exam_id'] ) ) {
                            $exam_id = sanitize_text_field( wp_unslash( $_GET['exam_id'] ) );
                        }
                        ?>
        ...
        if ( isset( $_POST['save_exam_time_table'] ) ) {
            ...
            // Sanitize and validate exam_id - intval() handles type casting, wp_unslash() not needed for integers
            $exam_data      = $obj_exam->mjschool_get_exam_by_id( isset( $_POST['exam_id'] ) ? intval( $_POST['exam_id'] ) : 0 );
            ...
            if ( $exam_data->section_id != 0 ) {
                ...
                if ( $school_type === 'university' ) {
                    ...
                    $subject_data = array_filter( $subject_data, function( $subject ) use ( $exam_subject_ids ) {
                        return in_array( (int) $subject->subid, $exam_subject_ids, true );
                    });
                }
            }
                ...
                <div class="col-md-12 mjschool-rtl-custom-padding-0px">
                    <div class="mjschool-exam-table-res">
                        <table class="table mjschool_examhall_border_1px_center" >
                            <thead>
                                <tr>
                                    <th class="mjschool-exam-hall-receipt-add-th-border-p mjschool_examhall_heading_medium"><?php esc_html_e( 'Class Name', 'mjschool' ); ?></th>
                                    <th class="mjschool-exam-hall-receipt-add-th-border-p mjschool_examhall_heading_medium"><?php esc_html_e( 'Section Name', 'mjschool' ); ?></th>
                                    <th class="mjschool-exam-hall-receipt-add-th-border-p mjschool_examhall_heading_medium"><?php esc_html_e( 'Exam Term', 'mjschool' ); ?></th>
                                    <th class="mjschool-exam-hall-receipt-add-th-border-p mjschool_examhall_heading_medium"><?php esc_html_e( 'Exam Start Date', 'mjschool' ); ?></th>
                                    <th class="mjschool-exam-hall-receipt-add-th-border-p mjschool_examhall_heading_medium"><?php esc_html_e( 'Exam End Date', 'mjschool' ); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
