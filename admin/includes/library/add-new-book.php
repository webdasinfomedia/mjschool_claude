        ...
        <div class="form-body mjschool-user-form">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group input mjschool-rtl-margin-0px">
                        <div class="col-md-12 form-control">
                            <input id="book_name" class="form-control validate[required] text-input" maxlength="50" type="text" value="<?php if ($edit) { echo esc_attr(stripslashes($result->book_name ) );} ?>" name="book_name">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group input mjschool-rtl-margin-0px">
                        <div class="col-md-12 form-control">
                            <input id="book_number" class="form-control text-input" maxlength="10" type="number" value="<?php if ($edit) { echo esc_attr(stripslashes($result->book_number ) ); }?>" name="book_number">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group input mjschool-rtl-margin-0px">
                        <div class="col-md-12 form-control">
                            <input id="publisher" class="form-control validate[required,custom[city_state_country_validation]] text-input" type="text" maxlength="50" value="<?php if ($edit) { echo esc_attr(stripslashes($result->publisher ) ); }?>" name="publisher">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group input">
                        <div class="col-md-12 form-control">
                            <input id="author_name" class="form-control validate[required,custom[city_state_country_validation]] text-input" maxlength="50" type="text" value="<?php if ($edit) { echo esc_attr(stripslashes($result->author_name ) ); }?>" name="author_name">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group input mjschool-rtl-margin-0px">
                        <div class="col-md-12 form-control">
                            ...
                            <label class="c" for="book_price"><?php echo esc_attr__( 'Price', 'mjschool' ) . '( ' . esc_html( mjschool_get_currency_symbol(get_option( 'mjschool_currency_code' ) ) ) . ' )'; ?><span class="mjschool-require-field">*</span></label>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 input">
