<?php
/**
 * Access Rights Management for support staff Role.
 *
 * Handles saving and retrieving access rights for the support staff role
...
// Check nonce for support staff access rights tab.
if ( isset( $_GET['tab'] ) ) {
...
/**
 * Handles saving and updating access rights for the support staff role.
 *
 * This code retrieves the existing access rights for support staff from the options table,
 ...
 * @since 1.0.0
 */
$result = get_option( 'mjschool_access_right_supportstaff' );
if ( isset( $_POST['save_access_right'] ) ) {
	$nonce = sanitize_text_field( wp_unslash( $_POST['_wpnonce'] ) );
	// Check save parent access rights nonce.
	if ( wp_verify_nonce( $nonce, 'mjschool_save_staff_access_right_nonce' ) ) {
		$role_access_right = array();
		$result = get_option( 'mjschool_access_right_supportstaff' );
		$role_access_right['supportstaff'] = array(
			// New Module Added. //
			'admission'         => array(
			...
			// custom_field. //
			'custom_field'      => array(
				'menu_icone' => esc_url(plugins_url( 'mjschool/assets/images/icons/mjschool-custom.png' ) ),
				'menu_title' => 'Custom Field',
				'page_link'  => 'custom-field',
			...
			'mjschool_setting'  => array(
				'menu_icone' => esc_url(plugins_url( 'mjschool/assets/images/icons/mjschool_setting.png' ) ),
			...
			'email_template'    => array(
				'menu_icone' => esc_url(plugins_url( 'mjschool/assets/images/icons/mjschool-email-template.png' ) ),
			...
			'general_settings'  => array(
				'menu_icone' => esc_url(plugins_url( 'mjschool/assets/images/icons/mjschool-general-settings.png' ) ),
...
$access_right = get_option( 'mjschool_access_right_supportstaff' );
/**
 * Display success messages for support staff role access rights.
 *
 * This code retrieves the saved access rights for the support staff role
...
switch ( $message ) {
	case '1':
		$message_string = esc_html__( 'Support Staff Access Right Updated Successfully.', 'mjschool' );
		break;
}
if ( $message ) {
	?>
...
<div><!--- PANEL WHITE DIV START. -->
	<div class="header">
		<h3 class="mjschool-first-header"><?php echo esc_html('Support Staff Access Right', 'mjschool' ); ?></h3>
	</div>
			...
			<div class="mjschool-access-right-menu row mjschool-border-bottom-0">
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['class_room']['own_data'], 1 ); ?> value="1" name="class_room_own_data">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked($access_right['supportstaff']['class_room']['view'],1);?> value="1" name="class_room_view">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-10">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked($access_right['supportstaff']['class_room']['add'],1);?> value="1" name="class_room_add">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked($access_right['supportstaff']['class_room']['edit'],1);?> value="1" name="class_room_edit">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked($access_right['supportstaff']['class_room']['delete'],1);?> value="1" name="class_room_delete">
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php if ( isset( $access_right['supportstaff']['certificate']['own_data'] ) ) { echo checked( $access_right['supportstaff']['certificate']['own_data'], 1 ); } ?> value="1" name="certificate_own_data">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php if ( isset( $access_right['supportstaff']['certificate']['view'] ) ) { echo checked( $access_right['supportstaff']['certificate']['view'], 1 ); } ?> value="1" name="certificate_view">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-10">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php if ( isset( $access_right['supportstaff']['certificate']['add'] ) ) { echo checked( $access_right['supportstaff']['certificate']['add'], 1 ); } ?> value="1" name="certificate_add">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php if ( isset( $access_right['supportstaff']['certificate']['edit'] ) ) { echo checked( $access_right['supportstaff']['certificate']['edit'], 1 ); } ?> value="1" name="certificate_edit">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php if ( isset( $access_right['supportstaff']['certificate']['delete'] ) ) { echo checked( $access_right['supportstaff']['certificate']['delete'], 1 ); } ?> value="1" name="certificate_delete">
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_setting']['own_data'], 1 ); ?> value="1" name="mjschool_setting_own_data" disabled>
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_setting']['view'], 1 ); ?> value="1" name="mjschool_setting_view">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-10">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_setting']['add'], 1 ); ?> value="1" name="mjschool_setting_add">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_setting']['edit'], 1 ); ?> value="1" name="mjschool_setting_edit">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_setting']['delete'], 1 ); ?> value="1" name="mjschool_setting_delete" disabled>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_template']['own_data'], 1 ); ?> value="1" name="mjschool_template_own_data" disabled>
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_template']['view'], 1 ); ?> value="1" name="mjschool_template_view">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-10">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_template']['add'], 1 ); ?> value="1" name="mjschool_template_add" disabled>
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_template']['edit'], 1 ); ?> value="1" name="mjschool_template_edit">
							</label>
						</div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 mjschool-menu-left-15">
						<div class="mjschool-checkbox">
							<label>
								<input type="checkbox" <?php echo checked( $access_right['supportstaff']['mjschool_template']['delete'], 1 ); ?> value="1" name="mjschool_template_delete" disabled>
							</label>
						</div>
					</div>
				</div>
