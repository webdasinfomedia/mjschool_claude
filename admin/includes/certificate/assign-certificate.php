        ...
        <div class="row">
            ...
            <div class="col-md-3 input">
                ...
                <select id="certificate_type" name="certificate_type" class="form-control max_mjschool-width-70px0 validate[required] mjschool_45px">
                    <!-- Static option. -->
                    <option value="transfer_static" <?php selected( $selected_cert, 'transfer_static' ); ?>>
            ...
            <div class="col-md-3 input mjschool-single-select">
                <label class="ml-1 mjschool-custom-top-label top" for="teacher_id"><?php esc_html_e( 'Class Teacher', 'mjschool' ); ?><span class="mjschool-require-field">*</span></label>
            ...
            <div class="col-md-3 input mjschool-single-select">
                <label class="ml-1 mjschool-custom-top-label top" for="teacher_new_id"><?php esc_html_e( 'Checked By', 'mjschool' ); ?></label>
...
<div class="latter_content">
    ...
    if ( isset( $_POST['save_latter'] ) ) {
        ...
        if ( ! empty( $certificate_type ) ) {
            ...
            echo esc_html__( 'No letter type selected.', 'mjschool' );
        }
    }
    ?>
</div>