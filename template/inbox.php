...
$message = $obj_message->mjschool_count_inbox_item( get_current_user_id() );
$max     = 10;
if ( isset( $_GET['pg'] ) ) {
...
echo $obj_message->mjschool_inbox_pagination( $totlal_message, $p, $lpm1, $prev, $next );
	...
	if ( ! empty( $message ) ) {
		...
		<div class="table-responsive" id="sentbox_table">
			<form name="wcwm_report" action="" method="post"><!-- Form-div. -->
				<?php wp_nonce_field( 'mjschool_inbox_form_action', 'mjschool_inbox_form_nonce' );?>
										...
										<tr>
											<td class="mjschool-user-image mjschool-width-50px-td mjschool-profile-image-prescription mjschool-padding-left-0">
												<p class="mjschool-prescription-tag mjschool-padding-15px mjschool-margin-bottom-0px <?php echo esc_attr( $color_class_css ); ?>">	
													<img src="<?php echo esc_url( MJSCHOOL_PLUGIN_URL . '/assets/images/dashboard-icon/icons/white-icons/mjschool-inbox.png' ); ?>" height="30px" width="30px" class="mjschool-massage-image" alt="<?php esc_attr_e( 'Inbox', 'mjschool' ); ?>">
												</p>
											</td>	
											<td>
											...
											<td>
												...
												?>
												<i class="fa-solid fa-circle-info mjschool-fa-information-bg" data-toggle="tooltip" data-placement="top" title="<?php if ( $msg->message_body ) { echo esc_attr( $msg->message_body ); } else { esc_attr_e( 'Description', 'mjschool' );} ?>"></i>   
											</td>
											<td>	
												<?php
												if ( ! empty( $attchment ) ) {
									...
									<tr>
										...
										<td>	
											...
											if ( ! empty( $attchment ) ) {
												...
												foreach ( $attchment_array as $attchment_data ) {
													?>
													<a target="blank" href="<?php echo esc_url( content_url( '/uploads/school_assets/' . basename( $attchment_data ) ) ); ?>" class="btn btn-default"><i class="fas fa-eye"></i> <?php esc_html_e( 'View Attachment', 'mjschool' ); ?></a>
													<?php
												}
											} else {
												esc_html_e( 'No Attachment', 'mjschool' );
