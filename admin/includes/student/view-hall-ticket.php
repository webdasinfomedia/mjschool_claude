                            ...
                            if ( ! empty( $exam_time_table ) ) {
                                foreach ( $exam_time_table as $retrieved_data ) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="mjschool-main-td mjschool-border-rigth mjschool-th-margin-hall"><?php echo esc_html( $obj_subject->mjschool_get_single_subject_name( $retrieved_data->subject_id ) ); ?></td>
                ...
                <div class="row mjschool-margin-top-10px-res mjschool-width-50-res col-md-8 col-sm-8 col-xs-8 mjschool-print-button pull-left mjschool-invoice-print-pdf-btn">
                    <div class="col-md-3 mjschool-pdf-btn-rs mjschool-width-50-res">
                        <a href="javascript:void(0)"
                            id="download_pdf"
                            class="btn mjschool-color-white mjschool-invoice-btn-div mjschool-save-btn">
                        ...
                        <tbody>
                            ...
                            if ( ! empty( $exam_time_table ) ) {
                                foreach ( $exam_time_table as $retrieved_data ) {
                                    ?>
                                    <tr>
                                        <td class="mjschool-main-td mjschool-border-rigth mjschool-th-margin-hall"><?php echo esc_html( $mjschool_subject->mjschool_get_single_subject_code( $retrieved_data->subject_id ) ); ?></td>
                                        <td class="mjschool-main-td mjschool-border-rigth mjschool-th-margin-hall"><?php echo esc_html( $mjschool_subject->mjschool_get_single_subject_name( $retrieved_data->subject_id ) ); ?></td>
                                        <td class="mjschool-main-td mjschool-border-rigth mjschool-th-margin-hall"><?php echo esc_html( mjschool_get_date_in_input_box( $retrieved_data->exam_date ) ); ?></td>
                                        <?php
                                        $start_time_data = explode( ':', $retrieved_data->start_time );
                                        $start_hour      = str_pad( $start_time_data[0], 2, '0', STR_PAD_LEFT );
