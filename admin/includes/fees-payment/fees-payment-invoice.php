...
$fees_pay_id                = intval( mjschool_decrypt_id( sanitize_text_field( wp_unslash( $_GET['idtest'] ) ) ) );
...
if ( sanitize_text_field( wp_unslash( $_GET['view_type'] ) ) === 'view_payment' ) {
	?>
				...
				<div id="mjschool-invoice-print" class="mjschool-main-div mjschool-float-left-width-100px mjschool-payment-invoice-popup-main-div">
					<div class="mjschool-invoice-width-100px mjschool-float-left" border="0">
						<div id="invoice-pdf" class="pdf-content-main mjschool-float-left-width-100px">
											...
											<div class="col-md-3 col-sm-4 col-xs-7 mjschool-float-left">
												<div class="">
													<div class="mjschool-width-20px" align="center">
														...
														?>
														<h5 class="mjschool-align-left">
															<label class="mjschool-popup-label-heading text-transfer-upercase"><?php esc_html_e( 'Date :', 'mjschool' ); ?></label>&nbsp; <label class="mjschool-invoice-model-value"><?php echo esc_attr( mjschool_get_date_in_input_box( wp_date( 'Y-m-d', strtotime( $issue_date ) ) ) ); ?></label>
														</h5>
														<h5 class="mjschool-align-left">
							...
							<div class="mjschool-width-100px mjschool-margin-top-10px-res mt-3">
												...
												foreach ( $fees_id as $id ) {
													if ( $id > 0 ) {
														...
														<tr>
															...
															<td class="mjschool-align-left mjschool-invoice-table-data mjschool_border_black_2px">
																<?php echo esc_html( $obj_fees->mjschool_get_fees_term_name( $id ) ); ?>
															</td>
															<td class="mjschool-align-left mjschool-invoice-table-data mjschool_border_black_2px">
																<?php
							...
							if ( ! empty( $fees_history_detail_result ) ) {
								?>
								<div  class="mjschool-width-100px mjschool-margin-top-10pr">
						...
						<div class="col-md-12 grand_total_main_div total_mjschool-padding-15px mjschool-rtl-float-none">
							<div class="row mjschool-margin-top-10px-res mjschool-width-50-res col-md-6 col-sm-6 col-xs-6 mjschool-print-button pull-left mjschool-invoice-print-pdf-btn">
								...
								if ( isset( $_REQUEST['web_type'] ) && sanitize_text_field( wp_unslash($_REQUEST['web_type'])) === 'wpschool_app' ) {
									...
									?>
									<div class="col-md-3 mjschool-pdf-btn-rs mjschool-width-50-res here123">
				...
				<div id="mjschool-invoice-print" class="mjschool-main-div mjschool-float-left-width-100px mjschool-payment-invoice-popup-main-div">
					<div class="mjschool-invoice-width-100px mjschool-float-left" border="0">
						...
						<div class="col-md-12 grand_total_main_div total_mjschool-padding-15px mjschool-rtl-float-none">
							<div class="row mjschool-margin-top-10px-res mjschool-width-50-res col-md-6 col-sm-6 col-xs-6 mjschool-print-button pull-left mjschool-invoice-print-pdf-btn">
								<div class="col-md-2 mjschool-print-btn-rs mjschool-width-50-res">
									<a href="<?php echo esc_url('?page=mjschool_fees_receipt&print=print&payment_id='. rawurlencode(wp_unslash( $_GET['idtest'] ) ).'&receipt_id='. esc_attr(  wp_unslash( $_GET['payment_id'] ) ) .'&fee_paymenthistory=fee_paymenthistory'); ?>" target="_blank" class="btn btn mjschool-save-btn mjschool-invoice-btn-div">
										<img src="<?php echo esc_url( MJSCHOOL_PLUGIN_URL . '/assets/images/listpage-icon/mjschool-print.png' ); ?>">
									</a>
								</div>
								<?php
								// Check this.
								if ( isset( $_GET['web_type'] ) && sanitize_text_field( wp_unslash( $_GET['web_type'] ) ) === 'wpschool_app' ) {
									if ( isset( $_POST['download_app_pdf'] ) ) {
										$file_path = content_url() . '/uploads/invoice_pdf/fees_payment/' . mjschool_decrypt_id( sanitize_text_field( wp_unslash( $_GET['idtest'] ) ) ) . '.pdf';
										if ( file_exists( ABSPATH . str_replace( content_url(), 'wp-content', $file_path ) ) ) {
											unlink( $file_path ); // Delete the file.
										}
										wp_safe_redirect( $file_path );
