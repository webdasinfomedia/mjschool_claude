							...
							<table width="100%" border="0">
								<tbody>
									...
									if ( isset( $fees_detail_result->discount_amount ) && ( $fees_detail_result->discount_amount != 0 ) ) {
										?>
										<tr>
											<td width="85%" class="mjschool-rtl-float-left_label mjschool-padding-bottom-15px mjschool-total-heading" align="<?php echo esc_html( $align ); ?>"> <?php echo esc_html__( 'Discount Amount', 'mjschool' ) . '( ' . esc_html( $discount_name ) . ' )' . '  :'; ?> </td>
									...
									if ( isset( $fees_detail_result->tax_amount ) && ( $fees_detail_result->tax_amount != 0 ) ) {
										?>
										<tr>
											<td width="85%" class="mjschool-rtl-float-left_label mjschool-padding-bottom-15px mjschool-total-heading" align="<?php echo esc_html( $align ); ?>"> <?php echo esc_html__( 'Tax Amount', 'mjschool' ) . '( ' . esc_html( $tax_name ) . ' )' . '  :'; ?> </td>
...
function mjschool_print_exam_receipt() {
	if ( isset( $_REQUEST['student_exam_receipt'] ) && sanitize_text_field(wp_unslash($_REQUEST['student_exam_receipt'])) === 'student_exam_receipt' ) {
		...
		<?php
		mjschool_student_exam_receipt_print( sanitize_text_field(wp_unslash($_REQUEST['student_id'])), $_REQUEST['exam_id'] );
		die();
	}
}
						...
						<table width="100%" border="0">
							<tbody>
								...
								<?php if ( isset( $invoice_data->tax_amount ) && ! empty( $invoice_data->tax_amount ) ) { ?>
									<tr>
										<td width="85%" class="mjschool-rtl-float-left_label mjschool-padding-bottom-15px mjschool-total-heading" align="right"> <?php echo esc_html__( 'Tax Amount', 'mjschool' ) . '( ' . esc_html( $tax_name ) . ' )' . '  :'; ?> </td>
								...
								<?php if ( isset( $invoice_data->discount_amount ) && ! empty( $invoice_data->discount_amount ) ) { ?>
									<tr>
										<td width="85%" class="mjschool-rtl-float-left_label mjschool-padding-bottom-15px mjschool-total-heading" align="right"> <?php echo esc_html__( 'Discount Amount', 'mjschool' ) . '( ' . esc_html( $discount_name ) . ' )' . '  :'; ?> </td>
											...
											<div class="mjschool-width-20px" align="right">
												...
												<h5 class="mjschool-align-left">
													...
													<label class="mjschool-invoice-model-value">
														<?php
														if ( $payment_status === 'Paid' ) {
															echo '<span class="mjschool-green-color mjschool_green_colors" >' . esc_html__( 'Fully Paid', 'mjschool' ) . '</span>';
														}
														if ( $payment_status === 'Part Paid' ) {
															echo '<span class="mjschool-purpal-color" >' . esc_html__( 'Partially Paid', 'mjschool' ) . '</span>';
														}
...
function mjschool_send_mail_receipt_pdf( $emails, $subject, $message, $student_id, $exam_id ) {
	...
	$mpdf->WriteHTML( '<div class="header mjschool-Examination-header"><span><strong class="mjschool-Examination-header-color">' . esc_html__( 'Examination Hall Ticket', 'mjschool' ) . '</strong></span></div>' );
	...
	$mpdf->WriteHTML( '<strong>' . esc_html__( 'Student Name', 'mjschool' ) . ' : </strong>' . $student_data->display_name . '</td>' );
	$mpdf->WriteHTML( '</td>' );
	$mpdf->WriteHTML( '</tr>' );
	$mpdf->WriteHTML( '<tr>' );
	$mpdf->WriteHTML( '<td class="mjschool-border-bottom-rigth" align="left">' );
	$mpdf->WriteHTML( '<strong>' . esc_html__( 'Roll Number', 'mjschool' ) . ' : </strong>' . $student_data->roll_id . ' </td>' );
	$mpdf->WriteHTML( '<td class="mjschool-border-bottom" align="left">' );
	$mpdf->WriteHTML( '<strong>' . esc_html__( 'Exam Name', 'mjschool' ) . ' : </strong>' . $exam_data->exam_name . '</td>' );
	$mpdf->WriteHTML( '</tr>' );
	$mpdf->WriteHTML( '<tr>' );
	$mpdf->WriteHTML( '<td class="mjschool-border-bottom-rigth" align="left">' );
	...
	$mpdf->WriteHTML( '<strong>' . esc_html__( 'Start Date', 'mjschool' ) . ' : </strong>' . mjschool_get_date_in_input_box( $exam_data->exam_start_date ) . '</td>' );
	$mpdf->WriteHTML( '<td class="mjschool-border-bottom-0" align="left">' );
	$mpdf->WriteHTML( '<strong>' . esc_html__( 'End Date', 'mjschool' ) . ' : </strong>' . mjschool_get_date_in_input_box( $exam_data->exam_end_date ) . '</td>' );
	$mpdf->WriteHTML( '</tr>' );
	$mpdf->WriteHTML( '</tbody>' );
	...
	$mpdf->WriteHTML( '<strong>' . esc_html__( 'Examination Centre', 'mjschool' ) . ' : </strong>' . $exam_hall_name . ',' . get_option( 'mjschool_name' ) . '</td>' );
	$mpdf->WriteHTML( '</tr>' );
	$mpdf->WriteHTML( '<tr>' );
	$mpdf->WriteHTML( '<td class="mjschool-border-bottom-0">' );
	$mpdf->WriteHTML( '<strong>' . esc_html__( 'Examination Centre Address', 'mjschool' ) . ' : </strong>' . get_option( 'mjschool_address' ) . '</td>' );
	$mpdf->WriteHTML( '</tr>' );
	$mpdf->WriteHTML( '</tbody>' );
	$mpdf->WriteHTML( '<tfoot>' );
	$mpdf->WriteHTML( '</tfoot>' );
	...
	$mpdf->WriteHTML( '<thead>' );
	$mpdf->WriteHTML( '<tr>' );
	$mpdf->WriteHTML( '<th colspan="5" class="mjschool-border-bottom">' . esc_html__( 'Time Table For Exam Hall', 'mjschool' ) . '</th>' );
	$mpdf->WriteHTML( '</tr>' );
	$mpdf->WriteHTML( '<tr class="mjschool-tr-back-color">' );
	$mpdf->WriteHTML( '<th class="mjschool-main-td mjschool-border-rigth mjschool-color-white mjschool_padding_10px">' . esc_html__( 'Subject Code', 'mjschool' ) . '</th>' );
	$mpdf->WriteHTML( '<th class="mjschool-main-td mjschool-border-rigth mjschool-color-white mjschool_padding_10px">' . esc_html__( 'Subject', 'mjschool' ) . '</th>' );
	$mpdf->WriteHTML( '<th class="mjschool-main-td mjschool-border-rigth mjschool-color-white mjschool_padding_10px">' . esc_html__( 'Exam Date', 'mjschool' ) . '</th>' );
	$mpdf->WriteHTML( '<th class="mjschool-main-td mjschool-border-rigth mjschool-color-white mjschool_padding_10px">' . esc_html__( 'Exam Time', 'mjschool' ) . '</th>' );
	$mpdf->WriteHTML( '<th class="mjschool-main-td mjschool-border-rigth mjschool-color-white mjschool_padding_10px">' . esc_html__( 'Examiner Sign.', 'mjschool' ) . '</th>' );
	$mpdf->WriteHTML( '</tr>' );
	$mpdf->WriteHTML( '</thead>' );
	$mpdf->WriteHTML( '<tbody>' );
	if ( ! empty( $exam_time_table ) ) {
		foreach ( $exam_time_table as $retrieved_data ) {
			...
			$end_am_pm       = $end_time_data[2];
			$end_time        = $end_hour . ':' . $end_min . ' ' . $end_am_pm;
			$mpdf->WriteHTML( '<td class="mjschool-main-td mjschool-border-rigth mjschool_padding_10px">' . $start_time . '' . esc_html__( 'To', 'mjschool' ) . '' . $end_time . '</td>' );
	...
	$mpdf->WriteHTML( '</table>' );
	$mpdf->WriteHTML( '</div>' );
	$mpdf->WriteHTML( '<div class="resultdate"><hr color="#97C4E7"><span>' . esc_html__( 'Student Signature', 'mjschool' ) . '</span></div>' );
	 
	$mpdf->WriteHTML( '<div class="signature"><span>
		<img src="' . $signature . '" style="width:100px; margin-right:15px;" />
	</span><hr color="#97C4E7"><span>' . esc_html__( 'Authorized Signature', 'mjschool' ) . '</span></div>' );
