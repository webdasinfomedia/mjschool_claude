	...
	$.validationEngineLanguage    = {
		newLang: function () {
			$.validationEngineLanguage.allRules = {
				...
				"onlyLetterSp": {
					"regex": /^[a-zA-ZáéíóúâêôãõçÁÉÍÓÚÂÊÔÃÕÇ\s']+$/,
				...
				"onlyLetterNumber": {
					"regex": /^[0-9a-zA-ZáéíóúâêôãõçÁÉÍÓÚÂÊÔÃÕÇ_\ \s]+$/,
					"alertText": "* Tylko litery, liczby i portugalskie znaki diakrytyczne"
				},
					// Start Custom Validation
				// 1)First Name,Last Name
				"onlyLetter_specialcharacter": {
					"regex": /^[a-zA-ZáéíóúâêôãõçÁÉÍÓÚÂÊÔÃÕÇ_\`,\.'\^\-\s]+$/,
					"alertText": "* Tylko litery i ' _,`.'^-' Dozwolone znaki, w tym polskie i portugalskie znaki diakrytyczne"
				},
				// 2 )City,State,Country
				"city_state_country_validation":
				{
					"regex": /^[a-zA-ZáéíóúâêôãõçÁÉÍÓÚÂÊÔÃÕÇ \_\,\`\.\'\^\-\&]+$/,
					"alertText": "* Tylko litery i ' _,`.'^-&' Dozwolone znaki"
				},
				// 3)PopUp Category,Medicine Name,Event Name
				"popup_category_validation":
				{
					"regex": /^[0-9a-zA-Z\u0104\u0106\u0118\u0141\u0143\u00D3\u015A\u0179\u017B\u0105\u0107\u0119\u0142\u0144\u00F3\u015B\u017A\u017CáéíóúâêôãõçÁÉÍÓÚÂÊÔÃÕÇ \_\,\`\.\'\^]+$/,
					"alertText": "* Tylko litery, cyfry i ' _,`.'^' Dozwolone znaki, w tym polskie i portugalskie znaki diakrytyczne"
				},
				...
				{
					"regex": /^[0-9a-zA-Z\u00C0-\u017FáéíóúâêôãõçÁÉÍÓÚÂÊÔÃÕÇ \ \?\_\,\`\.\:\[\]\'\^\-\&\n]+$/,
				...
				"username_validation":
				{
					"regex": /^[0-9a-zA-ZáéíóúâêôãõçÁÉÍÓÚÂÊÔÃÕÇ_\.\-\@]+$/,
					"alertText": "* Tylko litery, cyfry i '_.-@' Dozwolone znaki, w tym portugalskie znaki diakrytyczne"
				},
				// 6)Phone Number
				"phone_number":
				{
