	...
	$.validationEngineLanguage    = {
		newLang: function () {
			$.validationEngineLanguage.allRules = {
				...
				"onlyLetterSp": {
					"regex": /^[a-zA-ZĂăÂâÎîȘșȚț\s']+$/,
					"alertText": "* Sunt admise doar literele"
				},
				"onlyLetterAccentSp": {
					"regex": /^[a-zA-Z\u0102\u0103\u00C2\u00E2\u00CE\u00EE\u0218\u0219\u021A\u021B\s]+$/,
					"alertText": "* Sunt admise doar literele și caracterele cu accent"
				}
				,
				"onlyLetterNumber": {
					"regex": /^[0-9a-zA-Z]+$/,
				...
				"onlyLetter_specialcharacter": {
					"regex": /^[a-zA-ZĂăÂâÎîȘșȚț\s_\`,\.\'\^\-\ç\´\~]+$/,
					"alertText": "* Doar litere și caractere speciale permise: _,`.'^-"
				},
				// 2 )City,State,Country
				"city_state_country_validation": {
					"regex": /^[a-zA-ZĂăÂâÎîȘșȚț\s_\`,\.\'\^\-\&]+$/,
					"alertText": "* Doar litere și caractere: _,`.'^-& permise"
				},
				// 3)PopUp Category,Medicine Name,Event Name
				"popup_category_validation": {
					"regex": /^[0-9a-zA-ZĂăÂâÎîȘșȚț\s_\`,\.\'\^\ç\´\~]+$/,
					"alertText": "* Doar litere, cifre și caractere permise"
				},
				// 4)Address and Description
				"address_description_validation": {
					"regex": /^[0-9a-zA-ZĂăÂâÎîȘșȚț\s_\`,\.\'\^\(\)\"\/\:\;\?\[\]\=\+\*\%\$\#\@\!\-\&\n\ç\´\~]+$/,
					"alertText": "* Litere, cifre și simboluri comune permise"
				},
				// 5)UserName
				"username_validation": {
					"regex": /^[0-9a-zA-ZĂăÂâÎîȘșȚț_\.\-\@]+$/,
					"alertText": "* Doar litere, cifre și caractere: _. - @"
				},
				// 6)Phone Number
				"phone_number":
				{
				...
				"zipcode": {
					"regex": /^[0-9a-zA-ZĂăÂâÎîȘșȚț \-\+]+$/,
					"alertText": "* Cod poștal invalid"
				},
