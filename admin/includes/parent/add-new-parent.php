...
if ( isset( $_REQUEST['action'] ) && sanitize_text_field( wp_unslash( $_REQUEST['action'] ) ) === 'edit' ) {
	...
	$user_info = get_userdata( intval( mjschool_decrypt_id( $parent_id_encrypted ) ) );
}
$assign_parent = 0;
if ( isset( $_REQUEST['action'] ) && sanitize_text_field( wp_unslash( $_REQUEST['action'] ) ) === 'assign_parent' ) {
	$assign_parent = 1;
	$student_id_encrypted = isset( $_REQUEST['student_id'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['student_id'] ) ) : '';
	$student_id = intval( mjschool_decrypt_id( $student_id_encrypted ) );
}
?>
<div class="mjschool-panel-body"><!-- Mjschool-panel-body. -->
	<form name="parent_form" action="" method="post" class="mjschool-form-horizontal" id="parent_form" enctype="multipart/form-data"><!--  form div -->
		<?php $mjschool_action = isset( $_REQUEST['action'] ) ? sanitize_key( wp_unslash( $_REQUEST['action'] ) ) : 'insert'; ?>
					...
					<div class="form-group input">
						<div class="col-md-12 form-control mjschool-upload-profile-image-patient mjschool-res-rtl-height-50px">
							...
							<div class="col-sm-12 mjschool-display-flex">
								<input type="text" id="smgt_user_avatar_url" class="mjschool-image-path-dots form-control" name="smgt_user_avatar" value="<?php if ( $edit ) { echo esc_url( $user_info->smgt_user_avatar ); } elseif ( isset( $_POST['mjschool_user_avatar'] ) ) { echo esc_url( esc_url_raw( wp_unslash( $_POST['mjschool_user_avatar'] ) ) ); } ?>" readonly />
										...
										<div class="col-md-12 form-control mjschool-upload-profile-image-patient mjschool-res-rtl-height-50px">
											...
											<div class="col-sm-12 row">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 p-0">
													<a target="_blank" class="mjschool-status-read btn btn-default" href="<?php echo esc_url( content_url( '/uploads/school_assets/' . $value->document_file ) ); ?>" record_id="<?php echo esc_attr( $key ); ?>"><i class="fas fa-download"></i><?php esc_html_e( 'Download', 'mjschool' ); ?></a>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="col-md-5 col-10 col-sm-1">
							<div class="form-group input">
								<div class="col-md-12 form-control mjschool-upload-profile-image-patient mjschool-res-rtl-height-50px mjschool-file-height-padding">
									<span for="photo" class="mjschool-custom-control-label mjschool-custom-top-label ml-2"><?php esc_html_e( 'Document File', 'mjschool' ); ?></span>
									<div class="col-sm-12 mjschool-display-flex">
										<input id="upload_user_avatar_button" name="document_file[]" type="file" class="form-control file mjschool-file-validation" />
									</div>
								</div>
							</div>
						</div>
		...
		<div class="form-body mjschool-user-form"> <!--Mjschool-user-form div.-->
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12"><!-- Start save btn.-->
					<input type="submit" value="<?php if ( $edit ) { esc_attr_e( 'Save Parent', 'mjschool' ); } else { esc_attr_e( 'Add Parent', 'mjschool' ); } ?>" name="save_parent" class="mjschool-save-btn" />
				</div><!-- End save btn.-->
			</div>
		</div>
	</form><!--  Form div. -->
