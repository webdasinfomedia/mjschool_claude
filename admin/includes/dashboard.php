							...
							<h3 class="mjschool-addform-header-title mjschool-rtl-menu-backarrow-float">
								...
								if ( $request_page === 'mjschool' ) {
									...
									if ( $active_tab === 'addhomework' ) {
										?>
										<a href='<?php echo esc_url( admin_url() . 'admin.php?page=mjschool_student_homewrok&tab=homeworklist&_wpnonce='.esc_attr( $nonce ) ); ?>'>
											<img src="<?php echo esc_url( MJSCHOOL_PLUGIN_URL . "/assets/images/listpage-icon/mjschool-back-arrow.png"); ?>">
										</a>
										<?php
										if ( $mjschool_action === 'edit' ) {
									...
									if ( $active_tab === 'booklist' || $active_tab === 'addbook' ) {
										...
										?>
										<a href='<?php echo esc_url( admin_url() . 'admin.php?page=mjschool_library&tab=issuelist&_wpnonce='.esc_attr( $nonce ) ); ?>'>
											<img src="<?php echo esc_url( MJSCHOOL_PLUGIN_URL . "/assets/images/listpage-icon/mjschool-back-arrow.png"); ?>">
										</a>
										<?php
										esc_html_e( 'Issue & Return', 'mjschool' );
										...
										?>
										<a href='<?php echo esc_url( admin_url() . 'admin.php?page=mjschool_library&tab=booklist&_wpnonce='.esc_attr( $nonce ) ); ?>'>
											<img src="<?php echo esc_url( MJSCHOOL_PLUGIN_URL . "/assets/images/listpage-icon/mjschool-back-arrow.png"); ?>">
										</a>
										<?php
									...
									if ( $active_tab === 'addexam' || $active_tab === 'exam_time_table' ) {
										...
										<a href='<?php echo esc_url( admin_url() . 'admin.php?page=mjschool_exam&tab=examlist&_wpnonce='.esc_attr( $nonce ) ); ?>'>
								...
								elseif ( $mjschool_page_name === 'mjschool_notice' ) {
									...
									if ( $active_tab === 'add_certificate' ) {
										?>
										<a href='<?php echo esc_url( admin_url() . 'admin.php?page=mjschool_certificate&tab=certificatelist&_wpnonce='.esc_attr( $nonce ) ); ?>'>
											<img src="<?php echo esc_url( MJSCHOOL_PLUGIN_URL . "/assets/images/listpage-icon/mjschool-back-arrow.png"); ?>">
										</a>
										<?php
										if ( $mjschool_action === 'edit' ) {
									...
									if ( $active_tab === 'assign_certificate' ) {
										?>
										<a href='<?php echo esc_url( admin_url() . 'admin.php?page=mjschool_certificate&tab=assign_list&_wpnonce='.esc_attr( $nonce ) ); ?>'>
											<img src="<?php echo esc_url( MJSCHOOL_PLUGIN_URL . "/assets/images/listpage-icon/mjschool-back-arrow.png"); ?>">
										</a>
										<?php
										if ( $mjschool_action === 'edit' ) {
														...
														<li role="tab" class="disabled mjschool-wizard-responsive mjschool-wizard-title last <?php if ( $wizard_option['step5_class_time_table'] === 'yes' ) { echo 'done';} ?>" aria-disabled="true">
															<a id="form-total-t-2" href="admin.php?page=mjschool_route&tab=addroute" aria-controls="form-total-p-2">
																<div class="title">
																	...
																	<span class="step-number"><?php echo esc_attr__( 'Add Class Time Table', 'mjschool' ); ?></span>
																</div>
															</a>
														</li>
														<li role="tab" class="disabled mjschool-wizard-responsive mjschool-wizard-title last <?php if ( $wizard_option['step6_student'] === 'yes' ) { echo 'done';} ?>" aria-disabled="true">
															<a id="form-total-t-2" href="admin.php?page=mjschool_student&tab=addstudent" aria-controls="form-total-p-2">
																<div class="title">
																	...
																	<span class="step-number"><?php echo esc_attr__( 'Add Student', 'mjschool' ); ?></span>
																</div>
															</a>
														</li>
